...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>Sudoku/spec/cell_spec.rb at master · nabin369/Sudoku · GitHub</title>
...
<meta content="GitHub" property="og:site_name" /><meta content="object" property="og:type" /><meta content="https://0.gravatar.com/avatar/904d5bd859b9ac2e3bf7e7e341b26613?d=https%3A%2F%2Fidenticons.github.com%2F08deaac63edd44579bbcf47ed1b20d53.png&amp;r=x&amp;s=400" property="og:image" /><meta content="nabin369/Sudoku" property="og:title" /><meta content="https://github.com/nabin369/Sudoku" property="og:url" /><meta content="Contribute to Sudoku development by creating an account on GitHub." property="og:description" />
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="259D239A:0717:F1BCE6:52F220B3" name="octolytics-dimension-request_id" />
...
<meta content="Hia60H7Lzj4E4exFgYPrXgT6WroqPM2Nbw/00YVbYrM=" name="csrf-token" />
    ...
    <link href="https://github.global.ssl.fastly.net/assets/github2-9435e6151d831c7c0ea851d5963b20db08f8b3d0.css" media="all" rel="stylesheet" type="text/css" />
      ...
      <meta http-equiv="x-pjax-version" content="8447cdbc95f8302777cddcad10da94f0">
        ...
        <link data-pjax-transient rel='permalink' href='/nabin369/Sudoku/blob/3fb8e372cc9d44d55e5dd06053082c47856d8f97/spec/cell_spec.rb'>
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions">
      ...
      <a class="button signin" href="/login?return_to=%2Fnabin369%2FSudoku%2Fblob%2Fmaster%2Fspec%2Fcell_spec.rb">Sign in</a>
    </div>
...
<!-- blob contrib key: blob_contributors:v21:febbb86dd77a924e5d13aa17b8d58c60 -->
...
<div class="select-menu js-menu-container js-select-menu" >
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/nabin369/Sudoku/blob/master/spec/cell_spec.rb"
                 data-name="master"
                 data-skip-pjax="true"
                 rel="nofollow"
  ...
  <div class="commit file-history-tease">
    <img alt="nabin rai" class="main-avatar" height="24" src="https://1.gravatar.com/avatar/904d5bd859b9ac2e3bf7e7e341b26613?d=https%3A%2F%2Fidenticons.github.com%2F08deaac63edd44579bbcf47ed1b20d53.png&amp;r=x&amp;s=140" width="24" />
    ...
    <div id="blob_contributors_box" style="display:none">
      ...
      <ul class="facebox-user-list">
          <li class="facebox-user-list-item">
            <img alt="nabin rai" height="24" src="https://1.gravatar.com/avatar/904d5bd859b9ac2e3bf7e7e341b26613?d=https%3A%2F%2Fidenticons.github.com%2F08deaac63edd44579bbcf47ed1b20d53.png&amp;r=x&amp;s=140" width="24" />
    ...
    <div class="meta">
      ...
      <div class="actions">
        <div class="button-group">
          ...
          <a href="/nabin369/Sudoku/raw/master/spec/cell_spec.rb" class="button minibutton " id="raw-url">Raw</a>
            <a href="/nabin369/Sudoku/blame/master/spec/cell_spec.rb" class="button minibutton js-update-url-with-hash">Blame</a>
          <a href="/nabin369/Sudoku/commits/master/spec/cell_spec.rb" class="button minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->
...
<span id="L20" rel="#L20">20</span>
            ...
            <td class="blob-line-code"><div class="code-body highlight"><pre><div class='line' id='LC1'><span class="n">require_relative</span> <span class="s1">&#39;../lib/cell&#39;</span></div><div class='line' id='LC2'><br/></div><div class='line' id='LC3'><span class="n">describe</span> <span class="s1">&#39;Cell&#39;</span> <span class="k">do</span> </div><div class='line' id='LC4'><br/></div><div class='line' id='LC5'>	<span class="c1"># let(grid) { double :grid }</span></div><div class='line' id='LC6'>	<span class="n">let</span><span class="p">(</span><span class="ss">:cells</span><span class="p">)</span> <span class="p">{</span> <span class="no">Cell</span><span class="o">.</span><span class="n">new</span><span class="p">(</span><span class="ss">:value</span><span class="p">)</span> <span class="p">}</span></div><div class='line' id='LC7'><br/></div><div class='line' id='LC8'>		<span class="n">it</span> <span class="s1">&#39;checks if its filled out or solved&#39;</span> <span class="k">do</span></div><div class='line' id='LC9'>			<span class="c1"># cells = Cell.new(:value)</span></div><div class='line' id='LC10'><br/></div><div class='line' id='LC11'>			<span class="c1"># expect(grid).to receive(:solved?)</span></div><div class='line' id='LC12'>			<span class="c1"># cells.filled_out?.to eq(grid.solved?)</span></div><div class='line' id='LC13'>			<span class="n">expect</span><span class="p">(</span><span class="n">cells</span><span class="p">)</span><span class="o">.</span><span class="n">to</span> <span class="n">be_filled_out</span></div><div class='line' id='LC14'>		<span class="k">end</span></div><div class='line' id='LC15'><br/></div><div class='line' id='LC16'>	<span class="c1"># it &#39;checks the possible candidates&#39; do</span></div><div class='line' id='LC17'>	<span class="c1"># 	expect(cells.candidates([2])).to eq([1,2])</span></div><div class='line' id='LC18'>	<span class="c1"># end</span></div><div class='line' id='LC19'><br/></div><div class='line' id='LC20'><span class="k">end</span></div></pre></div></td>
          </tr>
        </table>
  </div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2014 <span title="0.02525s from github-fe123-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
