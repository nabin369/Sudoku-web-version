...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>Sudoku/lib/cell.rb at master · nabin369/Sudoku · GitHub</title>
...
<meta content="GitHub" property="og:site_name" /><meta content="object" property="og:type" /><meta content="https://0.gravatar.com/avatar/904d5bd859b9ac2e3bf7e7e341b26613?d=https%3A%2F%2Fidenticons.github.com%2F08deaac63edd44579bbcf47ed1b20d53.png&amp;r=x&amp;s=400" property="og:image" /><meta content="nabin369/Sudoku" property="og:title" /><meta content="https://github.com/nabin369/Sudoku" property="og:url" /><meta content="Contribute to Sudoku development by creating an account on GitHub." property="og:description" />
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="259D239A:071A:1028760:52F22040" name="octolytics-dimension-request_id" />
...
<meta content="qRS1SUW4tTVUxpT7ZnTmz8JOMeiMpV8Q8JmNuxvMdAA=" name="csrf-token" />
    ...
    <link href="https://github.global.ssl.fastly.net/assets/github2-9435e6151d831c7c0ea851d5963b20db08f8b3d0.css" media="all" rel="stylesheet" type="text/css" />
      ...
      <meta http-equiv="x-pjax-version" content="8447cdbc95f8302777cddcad10da94f0">
        ...
        <link data-pjax-transient rel='permalink' href='/nabin369/Sudoku/blob/3fb8e372cc9d44d55e5dd06053082c47856d8f97/lib/cell.rb'>
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions">
      ...
      <a class="button signin" href="/login?return_to=%2Fnabin369%2FSudoku%2Fblob%2Fmaster%2Flib%2Fcell.rb">Sign in</a>
    </div>
...
<!-- blob contrib key: blob_contributors:v21:83907b24b0b2da6bcdb448fbaa4972bc -->
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/nabin369/Sudoku/blob/master/lib/cell.rb"
                 data-name="master"
                 data-skip-pjax="true"
                 rel="nofollow"
    ...
    <div class="meta">
      ...
      <div class="actions">
        <div class="button-group">
          ...
          <a href="/nabin369/Sudoku/raw/master/lib/cell.rb" class="button minibutton " id="raw-url">Raw</a>
            <a href="/nabin369/Sudoku/blame/master/lib/cell.rb" class="button minibutton js-update-url-with-hash">Blame</a>
          <a href="/nabin369/Sudoku/commits/master/lib/cell.rb" class="button minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->
...
<span id="L32" rel="#L32">32</span>
            ...
            <td class="blob-line-code"><div class="code-body highlight"><pre><div class='line' id='LC1'><span class="k">class</span> <span class="nc">Cell</span></div><div class='line' id='LC2'><br/></div><div class='line' id='LC3'><br/></div><div class='line' id='LC4'><br/></div><div class='line' id='LC5'>	<span class="k">def</span> <span class="nf">initialize</span><span class="p">(</span><span class="n">value</span><span class="p">)</span></div><div class='line' id='LC6'>		<span class="vi">@value</span> <span class="o">=</span> <span class="n">value</span></div><div class='line' id='LC7'>		<span class="vi">@neighbour</span> <span class="o">=</span> <span class="o">[]</span></div><div class='line' id='LC8'>	<span class="k">end</span></div><div class='line' id='LC9'><br/></div><div class='line' id='LC10'>	<span class="kp">attr_accessor</span> <span class="ss">:value</span></div><div class='line' id='LC11'><br/></div><div class='line' id='LC12'>	<span class="k">def</span> <span class="nf">filled_out?</span></div><div class='line' id='LC13'>		<span class="vi">@value</span> <span class="o">&amp;&amp;</span> <span class="n">value</span> <span class="o">!=</span> <span class="mi">0</span></div><div class='line' id='LC14'>	<span class="k">end</span></div><div class='line' id='LC15'><br/></div><div class='line' id='LC16'>	<span class="k">def</span> <span class="nf">solve</span></div><div class='line' id='LC17'>		<span class="c1">#do nothing if solved</span></div><div class='line' id='LC18'>		<span class="c1"># request the list of candidates and </span></div><div class='line' id='LC19'>		<span class="c1"># get a new value if there&#39;s only one possible candidate</span></div><div class='line' id='LC20'>		<span class="k">return</span> <span class="k">if</span> <span class="n">filled_out?</span></div><div class='line' id='LC21'>		<span class="n">candidates</span> <span class="k">if</span> <span class="n">candidates</span><span class="o">.</span><span class="n">length</span> <span class="o">==</span> <span class="mi">1</span></div><div class='line' id='LC22'><br/></div><div class='line' id='LC23'>	<span class="k">end</span></div><div class='line' id='LC24'><br/></div><div class='line' id='LC25'>	<span class="k">def</span> <span class="nf">candidates</span></div><div class='line' id='LC26'>			<span class="p">(</span><span class="mi">1</span><span class="o">.</span><span class="n">.</span><span class="mi">9</span><span class="p">)</span><span class="o">.</span><span class="n">to_a</span> <span class="o">-</span> <span class="vi">@value</span></div><div class='line' id='LC27'>	<span class="k">end</span></div><div class='line' id='LC28'><br/></div><div class='line' id='LC29'>	<span class="k">def</span> <span class="nf">neighbour</span><span class="p">(</span><span class="n">value</span><span class="p">)</span></div><div class='line' id='LC30'>		<span class="vi">@value</span> <span class="o">&lt;&lt;</span> <span class="n">value</span></div><div class='line' id='LC31'>	<span class="k">end</span></div><div class='line' id='LC32'><span class="k">end</span></div></pre></div></td>
          </tr>
        </table>
  </div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2014 <span title="0.02123s from github-fe130-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
